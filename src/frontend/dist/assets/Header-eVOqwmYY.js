import { r as reactExports, j as jsxRuntimeExports, u as useInternetIdentity, a as useRouter } from "./index-DZ-iRrHU.js";
...
function Header() {
  ...
  const handleLandingScroll = (href) => {
    setMobileOpen(false);
    const el = document.querySelector(href);
    if (el) el.scrollIntoView({ behavior: "smooth" });
  };
  const handleAppNav = (href) => {
    setMobileOpen(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.header,
      {
        ...
        className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "backdrop-blur-xl bg-background/80 border-b border-white/5 shadow-[0_4px_24px_rgba(0,0,0,0.4)]" : "bg-transparent"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/20 border border-primary/40 flex items-center justify-center glow-blue transition-smooth group-hover:scale-105", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-bold tracking-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-blue-purple", children: "NeuroTrade" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/80", children: " AI" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
            {
              ...
              children: isLanding ? landingLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                ...
                link.href
              )) : appLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  "data-ocid": `header.${link.label.toLowerCase()}.link`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-3", children: [
            isLanding && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold text-gradient-blue-purple", children: "NeuroTrade AI" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              "nav",
              {
                ...
                children: isLanding ? landingLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(link.icon, { className: "w-4 h-4" }),
                      link.label
                    ]
                  },
                  link.href
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-auto pt-6 flex flex-col gap-2", children: isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
